...
(function () { 'use strict';
	...
	*/
	...
	function simplifyPathWithRatio(path, ratio_threshold, n) {
		...
		var distance_ratio = getSegLength(before, after) / ( getSegLength(current, before) + getSegLength(current, after) );

		// if (1 == distance_ratio) {
		// 	console.log(before, current, after);
		// }
		// console.log(getSegLength(before, after), distOfLine(before, after))
